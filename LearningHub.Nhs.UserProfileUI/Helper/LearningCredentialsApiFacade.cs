// <copyright file="LearningCredentialsApiFacade.cs" company="HEE.nhs.uk">
...
namespace LearningHub.Nhs.UserProfileUI.Helper
{
    ...
    /// <summary>
    /// Defines the <see cref="LearningCredentialsApiFacade" />.
    /// </summary>
    public class LearningCredentialsApiFacade : ILearningCredentialsApiFacade
    {
        /// <summary>
        /// Defines the _client.
        /// </summary>
        private readonly ILearningCredentialsApiHttpClient client;

        /// <summary>
        /// Initializes a new instance of the <see cref="LearningCredentialsApiFacade"/> class.
        /// </summary>
        /// <param name="client">The client<see cref="ILearningCredentialsApiHttpClient"/>.</param>
        public LearningCredentialsApiFacade(ILearningCredentialsApiHttpClient client)
        {
            this.client = client;
        }
