// <copyright file="BaseHttpClient.cs" company="HEE.nhs.uk">
...
namespace LearningHub.Nhs.UserProfileUI.Services
{
    ...
    using LearningHub.Nhs.UserProfileUI.Extensions;
    ...
    public abstract class BaseHttpClient
    {
        ...
        private async Task<string> RenewTokensAsync()
        {
            ...
            var tokenClient = new TokenClient(this.httpClient, new TokenClientOptions()
            {
                ...
                ClientId = this.WebSettings.AuthClientId,
                ClientSecret = this.WebSettings.AuthClientSecret,
            });
