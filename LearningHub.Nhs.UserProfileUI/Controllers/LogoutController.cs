...
namespace LearningHub.Nhs.UserProfileUI.Controllers
{
    ...
    public class LogoutController : Controller
    {
        ...
        /// The http client..
        /// </summary>
        private readonly ILearningCredentialsApiHttpClient httpClient;
        ...
        /// <param name="httpClient">The httpClient<see cref="ILearningCredentialsApiHttpClient"/>.</param>
        public LogoutController(
            IOptions<WebSettings> websettings,
            LogoutUserManager logoutSessions,
            ILearningCredentialsApiHttpClient httpClient)
        {
        ...
        private async Task<ClaimsPrincipal> ValidateJwt(string jwt, string authorityUrl)
        {
            ...
            var parameters = new TokenValidationParameters
            {
                ...
                ValidAudience = this.websettings.Value.AuthClientId,
